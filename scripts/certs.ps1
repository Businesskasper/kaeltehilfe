...
function PrepareKaeltehilfeCerts {
    ...
    # Prepare paths
    New-Item -Path ($exportPfxPath | Split-Path -Parent) -ItemType Directory -ea 0 | Out-Null
    New-Item -Path ($exportCrtPath | Split-Path -Parent) -ItemType Directory -ea 0 | Out-Null
